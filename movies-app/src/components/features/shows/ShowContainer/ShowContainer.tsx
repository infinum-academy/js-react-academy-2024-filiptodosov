...
export default function ShowContainer() {
  ...
  } = useSWR(swrKeys.showReviews(params.id as string), () =>
    getShowReviews(params.id as string)
  );

  const show: IShow = data?.show;

  const reviews = { reviewItems: reviewsData?.reviews || [] };
  ...
  return (
    <>
      ...
      <ShowReviewSection reviewList={reviews}></ShowReviewSection>
    </>
  );
}
